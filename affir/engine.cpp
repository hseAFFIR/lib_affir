...
Engine::Engine(EngineFocus engineFocus, FilterType filterFlags, IndexStorageType indexStorageType, const size_t buffer)
    ...
    TokenizerMode tokenizerMode = (engineFocus == EngineFocus::CONTEXT) ? TokenizerMode::NATIVE_POSES
                                                                        : TokenizerMode::CLEAR_POSES;
...
std::map<FileId, std::vector<std::string>>
Engine::returnResultInContext(const SearchResult &result, size_t contextSymbols) {
